...
export default function HomeClient({
  ...
  /* --------------------------------------------------------------------
        1.  DATA  — supplied by the server CMS loader
  -------------------------------------------------------------------- */
  ...
  const featured = pickShelfProducts(
    homepage.sections.featured.productSlugs,
    productBySlug,
  );
  const topPicks = pickShelfProducts(
    homepage.sections.topPicks.productSlugs,
    productBySlug,
  );
  ...
  const homepageCategories = useMemo(
    ...
    [categories, homepage.sections.browseCategories.categoryOrder],
  );
